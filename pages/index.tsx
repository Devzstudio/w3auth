...
export default function Home() {
	...
	return (
		<section className="grid place-items-center min-h-screen">
			...
			<div className="bg-white dark:bg-dark-700 px-5 py-3 rounded-xl pb-5 grid place-items-center w-72">
				{auth.token == '' ? (
					<>
						<LockClosedIcon className="w-20 h-20 mt-10 mb-10 text-dark-900" />
						<p className="text-xl mt-5 mb-5 text-gray-900 dark:text-gray-100">Login to continue</p>
						<p className="text-gray-500 text-sm mb-10">Login is only permitted to authorized users </p>

						<a
							onClick={openConnectModal}
							className="bg-gray-100 hover:bg-gray-200 cursor-pointer text-gray-500 hover:text-gray-900 rounded w-full text-center py-2"
						>
							Connect wallet
						</a>
					</>
